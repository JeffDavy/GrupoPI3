                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <form action="FuncionarioCadastroServlet" method="POST">
                                ...
                                <input type="email" name="emailFuncionario" class="form-control" id="emailFuncionario" placeholder="nome@exemplo.com">
                                <br>

                                <label for="tipo">Tipo:&emsp;</label>
                                <div class="form-check form-check-inline">

                                    <input class="form-check-input" type="radio" name="tipoFunc" id="adm" value="a">
                                    <label class="form-check-label" for="adm">
                                        Administrador &emsp;
                                    </label>

                                    <input class="form-check-input" type="radio" name="tipoFunc" id="funcionario" value="f">
