<%-- 
    Document   : FuncionarioHome
    Created on : 04/05/2021, 12:39:32
    Author     : dilaz
--%>
...
<html>
    <head>
        <meta name="viewport" 
            http-equiv="Content-Type" content="text/html; charset=UTF-8, width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
        ...
        <title>Funcionário - Locadora de Veículos</title>
    </head>
